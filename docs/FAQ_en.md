...
2、[How to enable the vision model for photo recognition](./mcp-vision-integration.md)<br/>
...
5、[How to get device information via an MCP method](./mcp-get-device-info.md)<br/>
...
9、[How to deploy context sources](./context-provider-integration.md)<br/>
10、[How to integrate PowerMem smart memory](./powermem-integration.md)<br/>
11、[How to configure the weather plugin to query the weather](./weather-integration.md)<br/>
12、[How to enable the device call plugin](./device-call-guide.md)<br/>
13、[How to enable the web search feature](./web-search-integration.md)<br/>
