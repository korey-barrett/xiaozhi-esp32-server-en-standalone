...
public interface Constant {
    ...
    /**
     * Console address shown when issuing the six-digit verification code
     */
    ...
    /**
     * Only report chat history (without summarizing memory)
     */
    ...
    /**
     * Volcano Engine dual-stream voice clone
     */
