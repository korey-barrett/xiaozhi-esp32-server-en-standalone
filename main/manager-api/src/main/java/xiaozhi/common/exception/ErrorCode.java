...
/**
 * Error codes are composed of 5 digits: the first 2 digits are the module code, and the last 3 digits are the business code
 * <p>
 * E.g. 10001 (10 represents the system module, 001 represents the business code)
 * </p>
...
public interface ErrorCode {
    ...
    int DICT_TYPE_DUPLICATE = 10077; // Duplicate dictionary type code

    // Resource processing related error codes
    int RESOURCE_READ_ERROR = 10078; // Failed to read resource

    // Agent related error codes
    int LLM_INTENT_PARAMS_MISMATCH = 10079; // LLM model and Intent recognition parameter mismatch

    // Voice print related error codes
    int VOICEPRINT_ALREADY_REGISTERED = 10080; // This voice print has already been registered
    int VOICEPRINT_DELETE_ERROR = 10081; // Error deleting voice print
    int VOICEPRINT_UPDATE_NOT_ALLOWED = 10082; // Voice print modification not allowed, voice already registered
    int VOICEPRINT_UPDATE_ADMIN_ERROR = 10083; // Error modifying voice print, please contact the administrator
    int VOICEPRINT_API_URI_ERROR = 10084; // Incorrect voice print interface address
    ...
    int VOICEPRINT_REGISTER_REQUEST_ERROR = 10087; // Voice print save request failed
    int VOICEPRINT_REGISTER_PROCESS_ERROR = 10088; // Voice print save processing failed
    int VOICEPRINT_UNREGISTER_REQUEST_ERROR = 10089; // Voice print unregister request failed
    int VOICEPRINT_UNREGISTER_PROCESS_ERROR = 10090; // Voice print unregister processing failed
    int VOICEPRINT_IDENTIFY_REQUEST_ERROR = 10091; // Voice print recognition request failed
    ...
    int LLM_REFERENCED_BY_INTENT = 10094; // This LLM model is referenced by the intent recognition configuration and cannot be deleted
    ...
    int WEBSOCKET_URL_FORMAT_ERROR = 10100; // Incorrect WebSocket address format
    ...
    int OTA_INTERFACE_ACCESS_FAILED = 10106; // Failed to access the OTA interface
    int OTA_INTERFACE_FORMAT_ERROR = 10107; // Incorrect content format returned by the OTA interface
    ...
    int MCP_INTERFACE_ACCESS_FAILED = 10112; // Failed to access the MCP interface
    int MCP_INTERFACE_FORMAT_ERROR = 10113; // Incorrect content format returned by the MCP interface
    int MCP_INTERFACE_VALIDATION_FAILED = 10114; // MCP interface validation failed
    int VOICEPRINT_URL_EMPTY = 10115; // Voice print interface address cannot be empty
    int VOICEPRINT_URL_LOCALHOST = 10116; // Voice print interface address cannot use localhost or 127.0.0.1
    int VOICEPRINT_URL_INVALID = 10117; // Not a valid voice print interface address
    int VOICEPRINT_URL_PROTOCOL_ERROR = 10118; // Voice print interface address must start with http or https
    int VOICEPRINT_INTERFACE_ACCESS_FAILED = 10119; // Failed to access the voice print interface
    int VOICEPRINT_INTERFACE_FORMAT_ERROR = 10120; // Incorrect content format returned by the voice print interface
    int VOICEPRINT_INTERFACE_VALIDATION_FAILED = 10121; // Voice print interface validation failed
    ...
    int DICT_LABEL_DUPLICATE = 10128; // Duplicate dictionary label
    ...
    int DOWNLOAD_LINK_INVALID = 10137; // Invalid download link
    ...
    int VOICE_RESOURCE_ACCOUNT_EMPTY = 10148; // Owning account cannot be empty
    ...
    int VOICE_CLONE_AUDIO_NOT_UPLOADED = 10151; // Please upload an audio file first
    ...
    int VOICE_CLONE_HUOSHAN_CONFIG_MISSING = 10155; // Volcano Engine is missing configuration
    ...
    int VOICE_CLONE_HUOSHAN_VOICE_ID_ERROR = 10160; // Volcano Engine voice ID format error
    ...
    int UPLOAD_FILE_ERROR = 10168; // Failed to upload file
    ...
    int RAG_API_ERROR_URL_NULL = 10171; // base_url is empty in the RAG configuration, please complete the configuration
    int RAG_API_ERROR_API_KEY_NULL = 10172; // api_key is empty in the RAG configuration, please complete the configuration
    int RAG_API_ERROR_API_KEY_INVALID = 10173; // api_key in the RAG configuration contains a placeholder, please replace it with the actual API key
    int RAG_API_ERROR_URL_INVALID = 10174; // base_url format in the RAG configuration is incorrect, please check whether the protocol is correct
    ...
    int RAG_DATASET_ID_AND_MODEL_ID_NOT_NULL = 10178; // dataset_id and model_id cannot be empty in the RAG configuration
    int RAG_FILE_NAME_NOT_NULL = 10179; // File name cannot be empty
    int RAG_FILE_CONTENT_EMPTY = 10180; // File content cannot be empty

    // Device related error codes (supplementary)
    int MCA_NOT_NULL = 10175; // MAC address cannot be empty

    // Voice clone (supplementary)
    ...
    // Agent template related error codes (supplementary)
    ...
    int OTA_UPLOAD_COUNT_EXCEED = 10195; // OTA upload count exceeds the limit
    ...
    int RAG_DOCUMENT_PARSING_DELETE_ERROR = 10199; // Document parsing in progress, deletion is forbidden

    // Agent MCP related error codes
    int MCP_ACCESS_POINT_ADDRESS_NO_PERMISSION = 10200; // No permission to view the MCP access point address of this agent
    int MCP_ACCESS_POINT_ADDRESS_NOT_CONFIGURED = 10201; // Please contact the administrator to configure the MCP access point address in parameter management
