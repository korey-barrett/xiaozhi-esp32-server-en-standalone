...
/**
 * Base service class; every Service must extend it.
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    protected IPage<T> getPage(Map<String, Object> params, String defaultOrderField, boolean isAsc) {
        ...
        // sort only if sort fields are present
        ...
        // no sort fields provided, use the default sort
    ...
    /**
     * <p>
     * Determine whether the database operation succeeded
     * </p>
     * <p>
     * Note!! This method checks Integer, so an int primitive type must not be passed.
     * </p>
     *
     * @param result the number of affected rows returned by the database operation
     * @return boolean
     */
