...
public class AgentDTO {
    ...
    @Schema(description = "Text-to-speech (TTS) model name", example = "tts_model_01")
    ...
    @Schema(description = "Persona/role setting parameters", example = "You are a professional customer service assistant responsible for answering user questions and providing help")
    ...
    @Schema(description = "Last connected time", example = "2024-03-20 10:00:00")
