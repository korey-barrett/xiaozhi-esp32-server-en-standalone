...
public class CorrectWordController {
    ...
    @PostMapping("/file")
    @Operation(summary = "Create a replacement word file")
    ...
    @Operation(summary = "Update a replacement word file")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Paginated retrieval of the current user's replacement word file list")
    @RequiresPermissions("sys:role:normal")
    @Parameters({
    ...
    @Operation(summary = "Agent retrieves the current user's replacement word file list")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Download a replacement word file")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Delete a replacement word file")
    @RequiresPermissions("sys:role:normal")
