...
public class ModelController {
    ...
    @Operation(summary = "Get the list of model providers")
    ...
    @GetMapping("/list")
    @Operation(summary = "Get the list of model configurations")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "Add a model configuration")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "Edit a model configuration")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "Enable/disable a model configuration")
    @RequiresPermissions("sys:role:superAdmin")
    public Result<Void> enableModelConfig(@PathVariable String id, @PathVariable Integer status) {
        ...
        if (status == 0 && entity.getIsDefault() > 0) {
            return new Result<Void>().error("The default model configuration cannot be disabled");
        }
        // Do not update the ConfigJson field
    ...
    @Operation(summary = "Set the default model")
    @RequiresPermissions("sys:role:superAdmin")
    public Result<Void> setDefaultModel(@PathVariable String id) {
        ...
        // Set the other models as non-default
        ...
        // Update the corresponding model ID in the template table
    ...
    @Operation(summary = "Get the voices of a model")
    @RequiresPermissions("sys:role:normal")
