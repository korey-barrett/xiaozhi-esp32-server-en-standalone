...
public class ModelProviderController {
    ...
    @PostMapping
    @Operation(summary = "Add a model provider")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PutMapping
    @Operation(summary = "Edit a model provider")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PostMapping("/delete")
    @Operation(summary = "Delete model providers")
    @RequiresPermissions("sys:role:superAdmin")
    @Parameter(name = "ids", description = "Array of IDs", required = true)
    ...
    @Tag(name = "Get the list of plugin names")
