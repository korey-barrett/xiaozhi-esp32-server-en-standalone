...
public class ALiYunSmsService implements SmsService {
    ...
    public void sendVerificationCodeSms(String phone, String VerificationCode) {
        ...
        try {
            ...
            // When running the copied code, print the API return value as needed
            SendSmsResponse sendSmsResponse = client.sendSmsWithOptions(sendSmsRequest, runtime);
            log.info("requestID of the SMS send response: {}", sendSmsResponse.getBody().getRequestId());
        } catch (Exception e) {
    ...
    private Client createClient(){
        ...
        try {
            ...
            // Configure the Endpoint. For the China site, use dysmsapi.aliyuncs.com
