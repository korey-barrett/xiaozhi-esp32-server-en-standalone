...
public class ServerActionResponseDTO
{
    ...
    private String type;
    private Map<String, Object> content; // This field can be removed later, using this class as a base class and writing a custom content type for each business
