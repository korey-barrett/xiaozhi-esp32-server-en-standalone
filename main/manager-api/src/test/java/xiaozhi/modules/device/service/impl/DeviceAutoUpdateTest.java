...
@DisplayName("Device Auto Upgrade Regression Test")
class DeviceAutoUpdateTest {
    ...
    @Test
    @DisplayName("#3299 OTA response omits firmware when auto-upgrade is disabled")
    ...
    @Test
    @DisplayName("Firmware lookup continues when auto-upgrade is enabled")
