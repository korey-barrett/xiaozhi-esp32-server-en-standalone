...
// Manually parse command-line arguments to obtain the mode
function getMode() {
...
export default defineManifestConfig({
  ...
  'versionCode': '100',
  'transformPx': false,
  'locale': VITE_FALLBACK_LOCALE, // e.g. 'zh-Hans'
  'h5': {
    router: {
  ...
  'mp-weixin': {
    ...
    permission: {
      'scope.userLocation': {
        desc: 'The WiFi provisioning feature requires location permission.',
      },
    },
