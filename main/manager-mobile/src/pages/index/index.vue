<!-- Use type="home" to mark the home page; other pages don't need this and default to "page" -->
<route lang="jsonc" type="home">
{
  "layout": "tabbar",
  "style": {
    // 'custom' enables a custom navigation bar; default is 'default'
...
// #ifdef MP-WEIXIN
// WeChat mini program uses the new API
...
// #ifndef MP-WEIXIN
// Other platforms keep using the uni API
...
async function queryList(pageNo: number, pageSize: number) {
  try {
    console.log('z-paging fetch agent list')
...
function goToEditAgent(agent: Agent) {
  // Pass the agent ID to the edit page
  uni.navigateTo({
...
// Refresh the list when the page is shown
onShow(() => {
...
// Content area start marker; creates a white background transition
