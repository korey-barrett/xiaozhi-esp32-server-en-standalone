...
function sendRequest() {
    return {
        ...
        'send'() {
            ...
            // Convert the locale code format, e.g. zh_CN to zh-CN
        ...
        // New method to set the response type
        'type'(responseType) {
...
/**
 * Info returned after the request completes
...
function httpHandlerError(info, failCallback, networkFailCallback) {
    ...
    /** Request succeeded, exit this function. Decide based on project requirements; here a status of 200 is considered success */
    ...
    if (networkFailCallback) {
        ...
        showDanger(`A network error occurred【${info.status}】`)
    }
    return true
}
