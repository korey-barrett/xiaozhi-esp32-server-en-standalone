...
// Return the matching icon path based on the volume state
...
const toggleMute = () => {
  ...
  // If unmuting and the volume is 0, restore the default volume
  if (!isMuted.value && volume.value === 0) {
    volume.value = 0.5
...
const updateSliderPosition = () => {
  nextTick(() => {
    ...
    // Position at the center of the button, vertically centered
