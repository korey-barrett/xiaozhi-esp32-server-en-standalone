...
export default {
  ...
  data() {
    return {
      ...
      dictTypeDialogTitle: 'Add Dict Type',
      dictTypeForm: {
        id: null,
        dictName: '',
        dictType: ''
      ...
      dictDataDialogTitle: 'Add Dict Data',
      dictDataForm: {
        id: null,
        dictTypeId: null,
        dictLabel: '',
  ...
  methods: {
    handleCheckAllChange(val) {
      // Decide whether to select all or deselect all based on the current selection state
      ...
      // Reset the indeterminate state
      this.isIndeterminate = false;
    },
    handleDictTypeSelectionChange(checkedIds) {
      // Update the selected dict type list
      this.selectedDictTypes = this.dictTypeList.filter(item => checkedIds.includes(item.dictName));
      // When partially selected, checkAll is true and isIndeterminate is true to show the half-selected state
