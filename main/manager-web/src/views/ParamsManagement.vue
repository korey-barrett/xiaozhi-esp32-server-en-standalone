      ...
      <div class="content-panel">
        <div class="content-area">
          <el-card class="params-card" shadow="never">
            ...
            >
              <!-- Custom slot for the selection column -->
  ...
  methods: {
    ...
    editParam(row) {
      ...
      this.paramForm = {
        ...
        valueType: row.valueType || "string", // ensure a value exists
        remark: row.remark
      };
      this.dialogVisible = true;
    },
    handleSubmit(form) {
      if (form.id) {
        ...
        Api.admin.updateParam(form, ({ data }) => {
          ...
          // Call ParamDialog's resetSaving method to reset the save state
    ...
    deleteParams(params) {
      ...
      this.$confirm(this.$t('paramManagement.confirmBatchDelete', { paramCount }), this.$t('message.warning'), {
        ...
        Api.admin.deleteParam(paramIds, ({ data }) => {
          if (data.code === 0) {
            // After deletion, check whether the page number needs to be adjusted
