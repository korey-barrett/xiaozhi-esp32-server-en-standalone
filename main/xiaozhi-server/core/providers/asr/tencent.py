...
class ASRProvider(ASRProviderBase):
    ...
    async def speech_to_text(
        ...
        try:
            ...
            if not self.secret_id or not self.secret_key:
                logger.bind(tag=TAG).error("Tencent Cloud ASR configuration is not set; recognition cannot proceed")
                return None, None
            ...
            # Obtain the authentication headers
    ...
    def _build_request_body(self, base64_audio: str) -> str:
        ...
        request_map = {
            ...
            "EngSerViceType": "16k_zh",  # General Mandarin Chinese
            "SourceType": 1,  # Audio data source is a voice file
    ...
    def _get_auth_headers(self, request_body: str) -> Tuple[str, str]:
        ...
        try:
            ...
            # Note: headers must be sorted by ASCII ascending order, and keys and values converted to lowercase
            # The content-type and host headers must be included
            content_type = "application/json; charset=utf-8"
            host = "asr.tencentcloudapi.com"
            action = "SentenceRecognition"  # API name

            # Build the canonical headers, noting the order and format
            canonical_headers = (
    ...
    def _send_request(
        ...
        try:
            ...
            if "Response" in response_json and "Result" in response_json["Response"]:
                ...
                logger.bind(tag=TAG).warning(f"No recognition result in the response: {response_json}")
                return ""
