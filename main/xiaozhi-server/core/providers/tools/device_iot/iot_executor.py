...
class DeviceIoTExecutor(ToolExecutor):
        ...
        try:
            ...
            if tool_name.startswith("get_"):
                ...
                if len(parts) >= 2:
                    ...
                    # Resolve placeholders in the response
        ...
        for descriptor in descriptors:
                        ...
                        "function": {
                            ...
                            "parameters": {
                                ...
                                "properties": {
                                    "response_success": {
                                        "type": "string",
                                        "description": f"Friendly reply on a successful query; use {{value}} as a placeholder for the queried value",
                                    },
                                    "response_failure": {
                                        "type": "string",
                                        "description": f"Friendly reply on a failed query",
                                    },
                                },
            ...
            if "methods" in descriptor:
                for method_name, method_info in descriptor["methods"].items():
                    ...
                    # Add the method's original parameters
                    ...
                    parameters.update(
                        {
                            "response_success": {
                                "type": "string",
                                "description": "Friendly reply on a successful operation",
                            },
                            "response_failure": {
                                "type": "string",
                                "description": "Friendly reply on a failed operation",
                            },
                        }
                    )
    ...
    def has_tool(self, tool_name: str) -> bool:
        """Check whether a given device-side IoT tool exists"""
