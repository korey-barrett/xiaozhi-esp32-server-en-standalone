    ...
    def __init__(self, config, delete_audio_file):
        ...
        if isinstance(self.params, str):
            try:
                ...
                raise ValueError("Custom TTS configuration parameters are invalid: unable to parse the string as an object")
        elif not isinstance(self.params, dict):
            raise TypeError("Custom TTS configuration parameters are invalid, please refer to the configuration documentation")
