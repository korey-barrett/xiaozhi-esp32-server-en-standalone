...
class TTSProvider(TTSProviderBase):
    def __init__(self, config, delete_audio_file):
        ...
        # Create Opus encoder. Note that the interface returns a sample rate of 24000
    ...
    def audio_to_opus_data_stream(
        ...
        """Convert audio file to Opus encoding, using 24kHz sample rate and its own encoder"""
        from core.utils.util import audio_to_data_stream
            ...
            with requests.post(self.api_url, json=payload, timeout=5) as response:
                ...
                for i in range(0, len(pcm_data), frame_bytes):
                    ...
                    if len(frame) < frame_bytes:
                        # The last frame may be short; pad with zeros
