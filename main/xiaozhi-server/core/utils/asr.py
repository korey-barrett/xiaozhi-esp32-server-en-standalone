...
def create_instance(class_name: str, *args, **kwargs) -> ASRProviderBase:
    """Factory method to create an ASR instance"""
    ...
    raise ValueError(f"Unsupported ASR type: {class_name}. Please check whether the 'type' for this config is set correctly")