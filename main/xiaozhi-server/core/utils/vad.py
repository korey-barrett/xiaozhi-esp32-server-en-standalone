...
def create_instance(class_name: str, *args, **kwargs) -> VADProviderBase:
    """Factory method to create a VAD instance"""
    ...
    raise ValueError(f"Unsupported VAD type: {class_name}, please check whether the type in the config is set correctly")
